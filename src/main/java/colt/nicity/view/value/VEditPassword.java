/*
 * VEditPassword.java.java
 *
 * Created on 03-12-2010 06:42:11 PM
 *
 ...
 */
public class VEditPassword extends Viewer {
     ...
     * @param _value
     */
    public VEditPassword(IValue _value) {
        this(_value, false);
    }
     ...
     * @param _w
     */
    public VEditPassword(IValue _value, int _w) {
     ...
     */
    public VEditPassword(IValue _value, boolean _setValueOnEnterOnly) {
     ...
     * @param _w
     */
    public VEditPassword(IValue _value, boolean _setValueOnEnterOnly, int _w) {
     ...
     * @param _setValueOnEnterOnly
     */
    public VEditPassword(Object _prefix, IValue _value, boolean _setValueOnEnterOnly) {
        this(_prefix, _value, null, _setValueOnEnterOnly);
    }
    private EditString password = null;//dg
     ...
     * @param _setValueOnEnterOnly
     */
    public VEditPassword(Object _prefix, IValue _value, Object _suffix, boolean _setValueOnEnterOnly) {
     ...
     * @param _w
     */
    public VEditPassword(Object _prefix, IValue _value, Object _suffix, boolean _setValueOnEnterOnly, int _w) {
     ...
     * @param _setValueOnEnterOnly
     */
    public VEditPassword(Place _place, Object _prefix, IValue _value, int _w, Object _suffix, boolean _setValueOnEnterOnly) {
        value = _value;
        setValueOnEnterOnly = _setValueOnEnterOnly;

        password = new EditString(this, _w, _w) {
            ...
            public void stringSet(String _string) {
                processString(_string);
                _setText(VEditPassword.this.toString());//??
                //setCaret(0);//??
            }
        };
        ...
        c.add(new VEditString(password));
        if (_suffix != null) {
