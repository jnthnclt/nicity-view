...
public class MouseDragged extends AMouseEvent {
     ...
     * @return
     */
    public boolean isXLatched() {
        return (latch == cXLatched);
    }
     ...
     * @return
     */
    public boolean isYLatched() {
        return (latch == cYLatched);
    }
