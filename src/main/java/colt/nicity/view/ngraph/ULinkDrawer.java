    ...
    public static LinkDrawer sideToSide(Object _key, final AColor _color) {
        LinkDrawer dld = new LinkDrawer(_key) {
            ...
            public void draw(ICanvas _g, XY_I _f, XY_I _t, double _rank, int _size) {
                ...
                IPath path = UPaint.toCurvedPath(new int[]{_f.x, mx, mx, mx, _t.x}, new int[]{_f.y, _f.y, my, _t.y, _t.y});
                _g.draw(path);
            }
        };
        return dld;
    ...
    public static LinkDrawer updown(
        ...
        LinkDrawer cUpDown = new LinkDrawer(_key) {
            ...
            public void draw(ICanvas _g, XY_I _f, XY_I _t, double _rank, int _size) {
                ...
                IPath path = UPaint.toCurvedPath(new int[]{_f.x, _f.x, mx, _t.x, _t.x}, new int[]{_f.y, my, my, my, _t.y});
                _g.draw(path);
            }
        };
        return cUpDown;
        ...
        LinkDrawer cWire = new LinkDrawer(_key) {
            ...
            public void draw(ICanvas _g, XY_I _f, XY_I _t, double _rank, int _size) {
                ...
                if (_f.y < _t.y) {
                    ...
                    IPath path = UPaint.toCurvedPath(new int[]{_f.x, _f.x, mx, mx, mx, _t.x, _t.x}, new int[]{_f.y, _f.y + 32, _f.y + 32, my, _t.y - 32, _t.y - 32, _t.y});
                    _g.draw(path);
                } else {
                    IPath path = UPaint.toCurvedPath(new int[]{_f.x, _f.x, mx, _t.x, _t.x}, new int[]{_f.y, my, my, my, _t.y});
                    _g.draw(path);
