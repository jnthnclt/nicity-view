 ...
 */
public class MouseEntered extends AMouseEvent {
    private Object exited;
    /**
     *
     * @param _who
     * @param source
    ...
    public static AMouseEvent newInstance(
		...
		boolean _isDragging,Object _exited
	) {
		MouseEntered e = new MouseEntered();
        e.who = _who;
		e.setSource(source);
		e.setX(x);
		e.setY(y);
